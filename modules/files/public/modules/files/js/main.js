var file_ids = {},
    ...
    taracot_dlg_edit = new UIkit.modal("#taracot_dlg_edit"),
    taracot_dlg_link = new UIkit.modal("#taracot_dlg_link"),
    taracot_dlg_upload = new UIkit.modal("#taracot_dlg_upload", {
        bgclose: false,
        keyboard: false
    }),
    buttons_state = [],
...
var taracot_dlg_upload_btn_cancel_handler = function() {
    if (refresh_required) btnrefresh_hanlder();
    taracot_dlg_upload.hide();
};
...
$('#taracot_dlg_upload_btn_cancel').click(taracot_dlg_upload_btn_cancel_handler);
