...
},toArray:function(){var a=this;return[a.year(),a.month(),a.date(),a.hours(),a.minutes(),a.seconds(),a.milliseconds()]},isValid:function(){return G(this)},isDSTShifted:function(){return this._a?this.isValid()&&w(this._a,(this._isUTC?sb.utc(this._a):sb(this._a)).toArray())>0:!1},parsingFlags:function(){return m({},this._pf)},invalidAt:function(){return this._pf.overflow},utc:function(a){return this.zone(0,a)},local:function(a){return this._isUTC&&(this.zone(0,a),this._isUTC=!1,a&&this.add(this._dateTzOffset(),"m")),this},format:function(a){var b=N(this,a||sb.defaultFormat);return this.localeData().postformat(b)},add:s(1,"add"),subtract:s(-1,"subtract"),diff:function(a,b,c){var d,e,f,g=K(a,this),h=6e4*(this.zone()-g.zone());return b=x(b),"year"===b||"month"===b?(d=432e5*(this.daysInMonth()+g.daysInMonth()),e=12*(this.year()-g.year())+(this.month()-g.month()),f=this-sb(this).startOf("month")-(g-sb(g).startOf("month")),f-=6e4*(this.zone()-sb(this).startOf("month").zone()-(g.zone()-sb(g).startOf("month").zone())),e+=f/d,"year"===b&&(e/=12)):(d=this-g,e="second"===b?d/1e3:"minute"===b?d/6e4:"hour"===b?d/36e5:"day"===b?(d-h)/864e5:"week"===b?(d-h)/6048e5:d),c?e:o(e)},from:function(a,b){return sb.duration({to:this,from:a}).locale(this.locale()).humanize(!b)},fromNow:function(a){return this.from(sb(),a)},calendar:function(a){var b=a||sb(),c=K(b,this).startOf("day"),d=this.diff(c,"days",!0),e=-6>d?"sameElse":-1>d?"lastWeek":0>d?"lastDay":1>d?"sameDay":2>d?"nextDay":7>d?"nextWeek":"sameElse";return this.format(this.localeData().calendar(e,this))},isLeapYear:function(){return E(this.year())},isDST:function(){return this.zone()<this.clone().month(0).zone()||this.zone()<this.clone().month(5).zone()},day:function(a){var b=this._isUTC?this._d.getUTCDay():this._d.getDay();return null!=a?(a=eb(a,this.localeData()),this.add(a-b,"d")):b},month:ob("Month",!0),startOf:function(a){switch(a=x(a)){case"year":this.month(0);case"quarter":case"month":this.date(1);case"week":case"isoWeek":case"day":this.hours(0);case"hour":this.minutes(0);case"minute":this.seconds(0);case"second":this.milliseconds(0)}return"week"===a?this.weekday(0):"isoWeek"===a&&this.isoWeekday(1),"quarter"===a&&this.month(3*Math.floor(this.month()/3)),this},endOf:function(a){return a=x(a),this.startOf(a).add(1,"isoWeek"===a?"week":a).subtract(1,"ms")},isAfter:function(a,b){return b=x("undefined"!=typeof b?b:"millisecond"),"millisecond"===b?(a=sb.isMoment(a)?a:sb(a),+this>+a):+this.clone().startOf(b)>+sb(a).startOf(b)},isBefore:function(a,b){return b=x("undefined"!=typeof b?b:"millisecond"),"millisecond"===b?(a=sb.isMoment(a)?a:sb(a),+a>+this):+this.clone().startOf(b)<+sb(a).startOf(b)},isSame:function(a,b){return b=x(b||"millisecond"),"millisecond"===b?(a=sb.isMoment(a)?a:sb(a),+this===+a):+this.clone().startOf(b)===+K(a,this).startOf(b)},min:f("moment().min is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548",function(a){return a=sb.apply(null,arguments),this>a?this:a}),max:f("moment().max is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548",function(a){return a=sb.apply(null,arguments),a>this?this:a}),zone:function(a,b){var c,d=this._offset||0;return null==a?this._isUTC?d:this._dateTzOffset():("string"==typeof a&&(a=Q(a)),Math.abs(a)<16&&(a=60*a),!this._isUTC&&b&&(c=this._dateTzOffset()),this._offset=a,this._isUTC=!0,null!=c&&this.subtract(c,"m"),d!==a&&(!b||this._changeInProgress?t(this,sb.duration(d-a,"m"),1,!1):this._changeInProgress||(this._changeInProgress=!0,sb.updateOffset(this,!0),this._changeInProgress=null)),this)},zoneAbbr:function(){return this._isUTC?"UTC":""},zoneName:function(){return this._isUTC?"Coordinated Universal Time":""},parseZone:function(){return this._tzm?this.zone(this._tzm):"string"==typeof this._i&&this.zone(this._i),this},hasAlignedHourOffset:function(a){return a=a?sb(a).zone():0,(this.zone()-a)%60===0},daysInMonth:function(){return B(this.year(),this.month())},dayOfYear:function(a){var b=vb((sb(this).startOf("day")-sb(this).startOf("year"))/864e5)+1;return null==a?b:this.add(a-b,"d")},quarter:function(a){return null==a?Math.ceil((this.month()+1)/3):this.month(3*(a-1)+this.month()%3)},weekYear:function(a){var b=hb(this,this.localeData()._week.dow,this.localeData()._week.doy).year;return null==a?b:this.add(a-b,"y")},isoWeekYear:function(a){var b=hb(this,1,4).year;return null==a?b:this.add(a-b,"y")},week:function(a){var b=this.localeData().week(this);return null==a?b:this.add(7*(a-b),"d")},isoWeek:function(a){var b=hb(this,1,4).week;return null==a?b:this.add(7*(a-b),"d")},weekday:function(a){var b=(this.day()+7-this.localeData()._week.dow)%7;return null==a?b:this.add(a-b,"d")},isoWeekday:function(a){return null==a?this.day()||7:this.day(this.day()%7?a:a-7)},isoWeeksInYear:function(){return C(this.year(),1,4)},weeksInYear:function(){var a=this.localeData()._week;return C(this.year(),a.dow,a.doy)},get:function(a){return a=x(a),this[a]()},set:function(a,b){return a=x(a),"function"==typeof this[a]&&this[a](b),this},locale:function(b){var c;return b===a?this._locale._abbr:(c=sb.localeData(b),null!=c&&(this._locale=c),this)},lang:f("moment().lang() is deprecated. Use moment().localeData() instead.",function(b){return b===a?this.localeData():this.locale(b)}),localeData:function(){return this._locale},_dateTzOffset:function(){return 15*Math.round(this._d.getTimezoneOffset()/15)}}),sb.fn.millisecond=sb.fn.milliseconds=ob("Milliseconds",!1),sb.fn.second=sb.fn.seconds=ob("Seconds",!1),sb.fn.minute=sb.fn.minutes=ob("Minutes",!1),sb.fn.hour=sb.fn.hours=ob("Hours",!0),sb.fn.date=ob("Date",!0),sb.fn.dates=f("dates accessor is deprecated. Use date instead.",ob("Date",!0)),sb.fn.year=ob("FullYear",!0),sb.fn.years=f("years accessor is deprecated. Use year instead.",ob("FullYear",!0)),sb.fn.days=sb.fn.day,sb.fn.months=sb.fn.month,sb.fn.weeks=sb.fn.week,sb.fn.isoWeeks=sb.fn.isoWeek,sb.fn.quarters=sb.fn.quarter,sb.fn.toJSON=sb.fn.toISOString,m(sb.duration.fn=l.prototype,{_bubble:function(){var a,b,c,d=this._milliseconds,e=this._days,f=this._months,g=this._data,h=0;g.milliseconds=d%1e3,a=o(d/1e3),g.seconds=a%60,b=o(a/60),g.minutes=b%60,c=o(b/60),g.hours=c%24,e+=o(c/24),h=o(pb(e)),e-=o(qb(h)),f+=o(e/30),e%=30,h+=o(f/12),f%=12,g.days=e,g.months=f,g.years=h},abs:function(){return this._milliseconds=Math.abs(this._milliseconds),this._days=Math.abs(this._days),this._months=Math.abs(this._months),this._data.milliseconds=Math.abs(this._data.milliseconds),this._data.seconds=Math.abs(this._data.seconds),this._data.minutes=Math.abs(this._data.minutes),this._data.hours=Math.abs(this._data.hours),this._data.months=Math.abs(this._data.months),this._data.years=Math.abs(this._data.years),this},weeks:function(){return o(this.days()/7)},valueOf:function(){return this._milliseconds+864e5*this._days+this._months%12*2592e6+31536e6*A(this._months/12)},humanize:function(a){var b=gb(this,!a,this.localeData());return a&&(b=this.localeData().pastFuture(+this,b)),this.localeData().postformat(b)},add:function(a,b){var c=sb.duration(a,b);return this._milliseconds+=c._milliseconds,this._days+=c._days,this._months+=c._months,this._bubble(),this},subtract:function(a,b){var c=sb.duration(a,b);return this._milliseconds-=c._milliseconds,this._days-=c._days,this._months-=c._months,this._bubble(),this},get:function(a){return a=x(a),this[a.toLowerCase()+"s"]()},as:function(a){var b,c;if(a=x(a),"month"===a||"year"===a)return b=this._days+this._milliseconds/864e5,c=this._months+12*pb(b),"month"===a?c:c/12;switch(b=this._days+qb(this._months/12),a){case"week":return b/7+this._milliseconds/6048e5;case"day":return b+this._milliseconds/864e5;case"hour":return 24*b+this._milliseconds/36e5;case"minute":return 24*b*60+this._milliseconds/6e4;case"second":return 24*b*60*60+this._milliseconds/1e3;case"millisecond":return Math.floor(24*b*60*60*1e3)+this._milliseconds;default:throw new Error("Unknown unit "+a)}},lang:sb.fn.lang,locale:sb.fn.locale,toIsoString:f("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",function(){return this.toISOString()}),toISOString:function(){var a=Math.abs(this.years()),b=Math.abs(this.months()),c=Math.abs(this.days()),d=Math.abs(this.hours()),e=Math.abs(this.minutes()),f=Math.abs(this.seconds()+this.milliseconds()/1e3);return this.asSeconds()?(this.asSeconds()<0?"-":"")+"P"+(a?a+"Y":"")+(b?b+"M":"")+(c?c+"D":"")+(d||e||f?"T":"")+(d?d+"H":"")+(e?e+"M":"")+(f?f+"S":""):"P0D"},localeData:function(){return this._locale}}),sb.duration.fn.toString=sb.duration.fn.toISOString;for(tb in fc)c(fc,tb)&&rb(tb.toLowerCase());return sb.duration.fn.asMilliseconds=function(){return this.as("ms")},sb.duration.fn.asSeconds=function(){return this.as("s")},sb.duration.fn.asMinutes=function(){return this.as("m")},sb.duration.fn.asHours=function(){return this.as("h")},sb.duration.fn.asDays=function(){return this.as("d")},sb.duration.fn.asWeeks=function(){return this.as("weeks")},sb.duration.fn.asMonths=function(){return this.as("M")},sb.duration.fn.asYears=function(){return this.as("y")},sb.locale("en",{ordinal:function(a){var b=a%10,c=1===A(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th";return a+c}}),sb}.call(this),a.Utils.moment=c,a.datepicker}),$.loadingIndicator();var current_id_hosting,current_id_domains,_history_handler_disable,dlg_lock=UIkit.modal("#dlg_lock",{bgclose:!1,keyboard:!1}),process_rows=[function(a,b,c){var d="cube";return"d"==c[5]&&(d="globe",a=a+"."+c[3]),'<label id="taracot-table-lbl-'+b+'"><input type="checkbox" class="taracot-table-chbx" id="taracot-table-chbx-'+b+'" rel="taracot-item_'+a+'"></div>&nbsp;<i class="uk-icon-'+d+'"></i>&nbsp;'+a+"</label>"},function(a){return a},function(a){return a},function(a,b,c){return"d"==c[5]&&(a=moment(parseInt(a)).format("L")),a},function(a,b){return'<div style="text-align:center;width:100px"><button class="uk-icon-button uk-icon-edit taracot-tableitem-edit" id="taracot-btnedt-'+b+'" type="button"></button>&nbsp;<button class="uk-icon-button uk-icon-button-danger uk-icon-trash-o taracot-tableitem-delete" id="taracot-btndel-'+b+'" type="button"></button></div>'}];$("#btn_select_all").click(function(){$(".taracot-table-chbx").prop("checked",!0)}),$("#btn_select_none").click(function(){$(".taracot-table-chbx").prop("checked",!1)}),$("#btn_delete_selected").click(function(){var a=[];$(".taracot-table-chbx").each(function(b,c){$(c).prop("checked")&&a.push($(c).attr("id").replace("taracot-table-chbx-",""))}),a.length>0&&delete_item(a)});var delete_item=function(a){for(var b=[],c=0;c<a.length;c++)b.push($("#taracot-table-chbx-"+a[c]).attr("rel").replace("taracot-item_",""));confirm(_lang_vars.del_confirm+"\n\n"+b.join(", "))&&($("#taracot_table").medvedTable("loading_indicator_show"),$.ajax({type:"POST",url:"/cp/billing_accounts/data/delete",data:{ids:a},dataType:"json",success:function(a){$("#taracot_table").medvedTable("loading_indicator_hide"),1==a.status?$("#taracot_table").medvedTable("update"):UIkit.notify({message:_lang_vars.delete_err_msg,status:"danger",timeout:2e3,pos:"top-center"})},error:function(){$("#taracot_table").medvedTable("loading_indicator_hide"),UIkit.notify({message:_lang_vars.delete_err_msg,status:"danger",timeout:2e3,pos:"top-center"})}}))},show_list=function(){$(".taracot-area").hide(),$("#billing_area_list").show(),push_state({mode:"list"},"?mode=list")},btn_add_hosting_handler=function(){push_state({mode:"add_hosting_account"},"?mode=add_hosting_account"),current_id_hosting=void 0,$(".taracot-area").hide(),$("#billing_area_hosting").show(),$(".taracot-form-hosting-control").each(function(){$(this).val(""),$(this).prop("selectedIndex",0),$(this).removeClass("uk-form-danger")}),$("#hosting_error").hide(),$("#billing_h1_hosting").html(_lang_vars.new_hosting_account),$("#haccount").focus()},btn_hosting_save_handler=function(){$(".taracot-form-hosting-control").each(function(){$(this).removeClass("uk-form-danger")}),$("#hosting_error").hide();var a=[],b=$.trim($("#haccount").val()),c=$.trim($("#huser").val()),d=$.trim($("#hplan").val()),e=$.trim($("#hexp").val());if(b.match(/^[A-Za-z0-9_\-]{3,20}$/)||a.push("#haccount"),c.match(/^[A-Za-z0-9_\-]{3,20}$/)||a.push("#huser"),d||a.push("#hplan"),e&&isInt(parseInt(e))||a.push("#hexp"),a.length){$(a[0]).focus();var f=_lang_vars.form_contains_errors+" (",g=[];for(var h in a)$(a[h]).addClass("uk-form-danger"),g.push('"'+$(a[h]).parent().parent().find("label").html()+'"');return f+=g.join(", ")+")",$("#hosting_error").html(f),void $("#hosting_error").show()}$.loadingIndicator("show"),$.ajax({type:"POST",url:"/cp/billing_accounts/data/save",data:{btype:"h",baccount:b,buser:c,bplan:d,bexp:e,id:current_id_hosting},dataType:"json",success:function(a){if(a&&1==a.status)show_list(),$("#taracot_table").medvedTable("update"),UIkit.notify({message:_lang_vars.hosting_save_success,status:"success",timeout:2e3,pos:"top-center"});else{var b=_lang_vars.ajax_failed;a.err_msg&&(b=a.err_msg),a.err_field&&($("#h"+a.err_field).addClass("uk-form-danger"),$("#h"+a.err_field).focus()),$("#hosting_error").html(b),$("#hosting_error").show()}},error:function(){UIkit.notify({message:_lang_vars.ajax_failed,status:"danger",timeout:2e3,pos:"top-center"})},complete:function(){$.loadingIndicator("hide")}})},btn_hosting_cancel_handler=function(){$.loadingIndicator("show"),$.ajax({type:"POST",url:"/cp/billing_accounts/data/unlock",data:{id:current_id_hosting},dataType:"json",complete:function(){$.loadingIndicator("hide"),show_list()}})},btn_add_domain_handler=function(){push_state({mode:"add_domain"},"?mode=add_domain"),current_id_domains=void 0,$(".taracot-area").hide(),$("#billing_area_domains").show(),$(".taracot-form-domains-control").each(function(){$(this).val(""),$(this).prop("selectedIndex",0),$(this).removeClass("uk-form-danger")}),$("#domains_error").hide(),$("#billing_h1_domains").html(_lang_vars.new_domain),$("#daccount").focus()},btn_domain_cancel_handler=function(){$.loadingIndicator("show"),$.ajax({type:"POST",url:"/cp/billing_accounts/data/unlock",data:{id:current_id_domains},dataType:"json",complete:function(){$.loadingIndicator("hide"),show_list()}})},btn_domain_save_handler=function(){$(".taracot-form-domains-control").each(function(){$(this).removeClass("uk-form-danger")}),$("#domains_error").hide();var a=[],b=$.trim($("#daccount").val()),c=$.trim($("#duser").val()),d=$.trim($("#dplan").val()),e=$.trim($("#dexp").val()),f=$.trim($("#dns0").val()),g=$.trim($("#dns1").val()),h=$.trim($("#dns0_ip").val()),i=$.trim($("#dns1_ip").val());if(b.match(/^[A-Za-zА-Яа-я0-9\-]{3,20}$/)||a.push("#daccount"),c.match(/^[A-Za-z0-9_\-]{3,20}$/)||a.push("#duser"),d||a.push("#dplan"),e||a.push("#dexp"),h&&!h.match(/^(?!0)(?!.*\.$)((1?\d?\d|25[0-5]|2[0-4]\d)(\.|$)){4}$/)&&a.push("#dns0_ip"),i&&!i.match(/^(?!0)(?!.*\.$)((1?\d?\d|25[0-5]|2[0-4]\d)(\.|$)){4}$/)&&a.push("#dns1_ip"),f&&f.match(/^(([a-zA-Z]{1})|([a-zA-Z]{1}[a-zA-Z]{1})|([a-zA-Z]{1}[0-9]{1})|([0-9]{1}[a-zA-Z]{1})|([a-zA-Z0-9][a-zA-Z0-9-_]{1,61}[a-zA-Z0-9]))\.([a-zA-Z]{2,6}|[a-zA-Z0-9-]{2,30}\.[a-zA-Z]{2,3})$/)||a.push("#dns0"),g&&g.match(/^(([a-zA-Z]{1})|([a-zA-Z]{1}[a-zA-Z]{1})|([a-zA-Z]{1}[0-9]{1})|([0-9]{1}[a-zA-Z]{1})|([a-zA-Z0-9][a-zA-Z0-9-_]{1,61}[a-zA-Z0-9]))\.([a-zA-Z]{2,6}|[a-zA-Z0-9-]{2,30}\.[a-zA-Z]{2,3})$/)||a.push("#dns1"),e=1e3*moment(e,billing_date_format).unix(),0>e&&a.push("#dexp"),a.length){$(a[0]).focus();var j=_lang_vars.form_contains_errors+" (",k=[];for(var l in a)$(a[l]).addClass("uk-form-danger"),k.push('"'+$(a[l]).parent().parent().find("label").html()+'"');return j+=k.join(", ")+")",$("#domains_error").html(j),void $("#domains_error").show()}$.loadingIndicator("show"),$.ajax({type:"POST",url:"/cp/billing_accounts/data/save",data:{btype:"d",baccount:b,buser:c,bplan:d,bexp:e,bns0:f,bns1:g,bns0_ip:h,bns1_ip:i,id:current_id_domains},dataType:"json",success:function(a){if(a&&1==a.status)show_list(),$("#taracot_table").medvedTable("update"),UIkit.notify({message:_lang_vars.domains_save_success,status:"success",timeout:2e3,pos:"top-center"});else{var b=_lang_vars.ajax_failed;a.err_msg&&(b=a.err_msg),a.err_field&&($("#d"+a.err_field).addClass("uk-form-danger"),$("#d"+a.err_field).focus()),$("#domains_error").html(b),$("#domains_error").show()}},error:function(){UIkit.notify({message:_lang_vars.ajax_failed,status:"danger",timeout:2e3,pos:"top-center"})},complete:function(){$.loadingIndicator("hide")}})},edit_item=function(a){push_state({mode:"edit",id:a},"?mode=edit&id="+a),$.loadingIndicator("show"),$.ajax({type:"POST",url:"/cp/billing_accounts/data/load",data:{id:a},dataType:"json",success:function(a){if(a&&1==a.status)a.account&&a.account.btype&&("h"==a.account.btype&&(current_id_hosting=a.account._id,current_id_domains=void 0,$(".taracot-area").hide(),$("#billing_area_hosting").show(),$(".taracot-form-hosting-control").each(function(){$(this).val(""),$(this).prop("selectedIndex",0),$(this).removeClass("uk-form-danger")}),$("#hosting_error").hide(),$("#billing_h1_hosting").html(_lang_vars.edit_hosting_account),$("#haccount").val(a.account.baccount),$("#huser").val(a.account.buser_save),$("#hplan").val(a.account.bplan),$("#hexp").val(a.account.bexp),$("#haccount").focus()),"d"==a.account.btype&&(current_id_hosting=void 0,current_id_domains=a.account._id,$(".taracot-area").hide(),$("#billing_area_domains").show(),$(".taracot-form-domains-control").each(function(){$(this).val(""),$(this).prop("selectedIndex",0),$(this).removeClass("uk-form-danger")}),$("#domains_error").hide(),$("#billing_h1_domains").html(_lang_vars.edit_domain),$("#daccount").val(a.account.baccount),$("#duser").val(a.account.buser_save),$("#dplan").val(a.account.bplan),$("#dexp").val(moment(parseInt(a.account.bexp)).format(billing_date_format)),$("#dns0").val(a.account.bns0||""),$("#dns0_ip").val(a.account.bns0_ip||""),$("#dns1").val(a.account.bns1||""),$("#dns1_ip").val(a.account.bns1_ip||""),$("#daccount").focus()),a.account.block&&a.account.block!=current_user&&($("#document_locked_by").html(a.account.block),dlg_lock.show()));else{var b=_lang_vars.ajax_failed;a.err_msg&&(b=a.err_msg),UIkit.notify({message:b,status:"danger",timeout:2e3,pos:"top-center"})}},error:function(){UIkit.notify({message:_lang_vars.ajax_failed,status:"danger",timeout:2e3,pos:"top-center"})},complete:function(){$.loadingIndicator("hide")}})},btn_unlock_handler=function(){dlg_lock.hide(),$.loadingIndicator("show"),$.ajax({type:"POST",url:"/cp/billing_accounts/data/unlock",data:{id:current_id_hosting},dataType:"json",complete:function(){$.loadingIndicator("hide")}})},btn_dont_unlock_handler=function(){dlg_lock.hide(),show_list()},bind_history=function(){History.Adapter.bind(window,"statechange",function(){history_handler()})},history_handler=function(){if(!_history_handler_disable){var a=History.getState();if(a.data.mode)switch(a.data.mode){case"list":show_list();break;case"add_hosting_account":$("#btn_add_hosting").click();break;case"add_domain":$("#btn_add_domain").click();break;case"edit":a.data.id&&edit_item(a.data.id)}}},push_state=function(a,b){_history_handler_disable=!0,History.pushState(a,save_title,b),_history_handler_disable=!1};$(document).ready(function(){moment.lang(current_locale),$("#taracot_table").medvedTable({col_count:5,sort_mode:1,sort_cell:"baccount",taracot_table_url:"/cp/billing_accounts/data/list",process_rows:process_rows,error_message:_lang_vars.ajax_failed});for(var a=0;a<init_hosting.length;a++)$("#hplan").append('<option value="'+init_hosting[a].id+'">'+init_hosting[a][current_locale]+"</option>");for(var b=0;b<init_domains.length;b++)$("#dplan").append('<option value="'+init_domains[b].id+'">'+init_domains[b].id+"</option>");$("#btn_add_hosting").click(btn_add_hosting_handler),$("#btn_add_domain").click(btn_add_domain_handler),$("#btn_hosting_cancel").click(btn_hosting_cancel_handler),$("#btn_domain_cancel").click(btn_domain_cancel_handler),$("#btn_hosting_save").click(btn_hosting_save_handler),$("#btn_domain_save").click(btn_domain_save_handler),$("#btn_unlock").click(btn_unlock_handler),$("#btn_dont_unlock").click(btn_dont_unlock_handler),$(".taracot-form-hosting-control").bind("keypress",function(a){submitOnEnter(a)&&$("#btn_hosting_save").click()}),$(".taracot-form-domains-control").bind("keypress",function(a){submitOnEnter(a)&&$("#btn_domain_save").click()}),bind_history(),History.getState().data&&History.getState().data.mode||($.queryString.mode?push_state({mode:$.queryString.mode,id:$.queryString.id||""},"?mode="+$.queryString.mode+"&id="+$.queryString.id||""):show_list()),history_handler()});