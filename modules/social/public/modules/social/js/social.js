    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.status == 1) {
                ...
                var buttons = '';
                if (current_user.id != data.user._id) buttons += '<button class="uk-button uk-button-small" id="btn_add_friend_' + data.user._id + '"><i class="uk-icon-plus"></i>&nbsp;' + _lang_vars.add_friend + '</button>';
